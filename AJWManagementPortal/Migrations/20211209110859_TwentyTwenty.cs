...
{
    public partial class TwentyTwenty : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MPDate = table.Column<string>(nullable: false),
                    MPName = table.Column<string>(nullable: false),
                    MPDesignation = table.Column<string>(nullable: false),
                    Timein = table.Column<string>(nullable: false),
                    Timeout = table.Column<string>(nullable: false),
                    MPDescription = table.Column<string>(nullable: false),
                    Signofficer = table.Column<string>(nullable: true),
                    SignPManagerMP = table.Column<string>(nullable: false),
                    PManagerRemarksMP = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SignPManager = table.Column<string>(nullable: false),
                    PManagerRemarks = table.Column<string>(nullable: false),
                    SignGM = table.Column<string>(nullable: true),
                    GMRemarks = table.Column<string>(nullable: true),
                    SignCeo = table.Column<string>(nullable: true),
                    CeoRemarks = table.Column<string>(nullable: true),
