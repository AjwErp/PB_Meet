    ...
    public class DailyAccountReportController : Controller
    {
        ...
        public async Task<IActionResult> IndexByName(String id, String hide)
        {
            ...
            trans.aDailyCashes = _db.aDailyCashes.
                Where(z => z.ValueDate <= dateTime10 && z.DelCeo !=0 && (Convert.ToInt32(z.Status) >= 1 && Convert.ToInt32(z.Status) <= 3))
                .ToList();
        ...
        //POST- for index method
        //ended--POST- for index method
        public async Task<IActionResult> IndexByName2(String id, String hide)
        {
            trans.hide = Boolean.Parse(hide);
            if (id == null)
            {
            ...
            trans.date = dateTime10;
            trans.aDailyCashes = _db.aDailyCashes.
                Where(z => z.ValueDate <= dateTime10 && z.DelCeo !=0 && (Convert.ToInt32(z.Status) ==6 ))
                .ToList();
        ...
        public async Task<IActionResult> Index()
        {
            ...
            trans.aDailyCashes = _db.aDailyCashes.
                Where(z => z.ValueDate <= today && z.DelCeo != 0 && (Convert.ToInt32(z.Status) >= 1 && Convert.ToInt32(z.Status) <= 3))
                .ToList();
            trans.date = today;
        ...
        public async Task<IActionResult> DeleteSheet(String remarks)
        {
            ...
            data = _db.aDailyCashes.Where(i => i.ValueDate.Equals(dateTime10) && i.DelCeo != 0 && (Convert.ToInt32(i.Status) >= 1 && Convert.ToInt32(i.Status) <= 3)).ToList();
        ...
        public IActionResult DailyContinueReport()
        {
            DateTime today = DateTime.Today;
            //trans.aDailyCashes = _db.aDailyCashes.
            //    Where(z => z.ValueDate <= today && z.DelCeo != 0 && (Convert.ToInt32(i.Status) >= 1 && Convert.ToInt32(i.Status) <= 3))
            //    .ToList();
            trans.date = today;
        ...
        public async Task<IActionResult> TransactionSheet3(String id, String hide)
        {
            if (id == null)
            {
                return NotFound();
        ...
        public async Task<IActionResult> TransactionSheet2()
        {
            DateTime today = DateTime.Today;
            trans.aDailyCashes = _db.aDailyCashes.
                Where(z => (z.ValueDate <= today || z.lnClearedAmount != 0) && z.DelCeo != 0 && (Convert.ToInt32(z.Status) >= 1 && Convert.ToInt32(z.Status) <= 3))
                .ToList();
            trans.date = today;
            return View("DailyTransactionReport", trans);
        }
        ...
        {
            ViewBag.hide = false;
            return View(_db.MeezanBankIEReports.Where(q => q.DelCeo != 0).ToList());
        }//Get -3 for Daily Meezan bank income/Expence Report
        public IActionResult DailyMeezanBankIEReport2(String Id, String hide)
        {
            ...
            Id = Id.Replace("-", "/");
            DateTime dateTime10 = DateTime.Parse(Id);
            return View("DailyMeezanBankIEReport", _db.MeezanBankIEReports.Where(q => q.ValueDate.Equals(dateTime10) && q.DelCeo != 0).ToList());
        }
        ...
        public IActionResult DailyGeneralLedgerReport(String id, String hide)
        {
            ...
            trans.date = dateTime10;
            trans.aDailyCashes = _db.aDailyCashes.
                Where(z => z.ValueDate <= dateTime10 && z.DelCeo != 0)
                .ToList();
            return View("DailyGeneralLedgerReport", trans);
        }
        

        public IActionResult DailyGeneralLedgerReport1(String id, String hide)
        {
            if (id == null)
            {
                return NotFound();
        ...
        public IActionResult DailyGeneralLedgerReport2()
        {
            DateTime today = DateTime.Today;
            trans.aDailyCashes = _db.aDailyCashes.
                Where(z => (z.ValueDate <= today || z.lnClearedAmount != 0) && z.DelCeo != 0)
                .ToList();
            trans.date = today;
            return View("DailyGeneralLedgerReport", trans);
        }
        ...
        public IActionResult AllDailyAccountsReports()
        {
            ...
            dM.aDailyCashes = _db.aDailyCashes.Where(i => i.DelCeo != 0 && (Convert.ToInt32(i.Status) >= 1 && Convert.ToInt32(i.Status) <= 3)).ToList().GroupBy(elem => elem.ValueDate).Select(group => group.First()); ;
            dM.Bank = _db.MeezanBankIEReports.Where(i => i.DelCeo != 0 && (Convert.ToInt32(i.Status) >= 1 && Convert.ToInt32(i.Status) <= 3)).ToList().GroupBy(elem => elem.ValueDate).Select(group => group.First()); ;
        ...
        [HttpGet]
        public async Task<IActionResult> closngVoucher1(String id, String hide)
        {
            trans.hide = Boolean.Parse(hide);
            if (id == null)
            {
        ...
        [HttpPost]
        public IActionResult closngVoucher1(List<IFormFile> files, String id)
        {
            id = id.Replace("-", "/");
            DateTime dateTime10 = DateTime.Parse(id);
        ...
        public async Task<IActionResult> BnkIndex1(String id, String hide)
        {
            trans.hide = Boolean.Parse(hide);
            if (id == null)
            {
        ...
        public IActionResult SendToAccountOfficeBank(string remarks)
        {
            ...
            List<MeezanBankIEReport> data = new List<MeezanBankIEReport>();
            DateTime dateTime10 = DateTime.Parse(remarks);
            data = _db.MeezanBankIEReports.Where(i => i.ValueDate.Equals(dateTime10) && i.DelCeo!= 0 && (Convert.ToInt32(i.Status) >= 1 && Convert.ToInt32(i.Status) <= 3)).ToList();
        ...
        public IActionResult SendToAccountOfficeSupplier(string remarks)
        {
            ...
            List<DailySuppliersCashTransactionReport> data = new List<DailySuppliersCashTransactionReport>();
            DateTime dateTime10 = DateTime.Parse(remarks);
            data = _db.dailySuppliers.Where(i => i.ValueDate.Equals(dateTime10) && i.DelCeo!= 0 && (Convert.ToInt32(i.Status) >= 1 && Convert.ToInt32(i.Status) <= 3)).ToList();
        ...
        public IActionResult SendToGmOfficeBank(string remarks)
        {
            ...
            List<MeezanBankIEReport> data = new List<MeezanBankIEReport>();
            DateTime dateTime10 = DateTime.Parse(remarks);
            data = _db.MeezanBankIEReports.Where(i => i.ValueDate.Equals(dateTime10) && i.DelCeo != 0).ToList();
        ...
        public JsonResult InsertCustomers(List<aDailyCash> data, DateTime id)
        {
            ...
            trans.aDailyCashes = _db.aDailyCashes.Where(z => z.ValueDate == dateTime10 || (z.ValueDate < dateTime10 && z.lnClearedAmount != 0) && z.DelCeo!= 0 && (Convert.ToInt32(z.Status) >= 1 && Convert.ToInt32(z.Status) <= 3)).ToList();
        ...
        }public JsonResult InsertCustomers1(List<aDailyCash> data, DateTime id)
        {
        ...
        public JsonResult InsertSuppliers1(List<DailySuppliersCashTransactionReport> data, String id)
        {
            ...
            trans.suppliers = _db.dailySuppliers.Where(z => z.ValueDate == dateTime10 || (z.ValueDate < dateTime10) && z.DelCeo != 0).ToList();
            //List<int> intersection = trans.aDailyCashes.Cast<int>().Intersect(data.Cast<int>()).ToList();
